...
@testset "RDFLib.jl" begin
    ...
    include("test_ntriples_edge_cases.jl")
    include("test_turtle.jl")
    include("test_turtle_edge_cases.jl")
    include("test_dataset.jl")
    include("test_dataset_extras.jl")
    ...
    include("test_sparql_extras.jl")
    include("test_sparql_having.jl")
    include("test_sparql_remote.jl")
    include("test_sparql_spec.jl")
    include("test_sparql12.jl")
    include("test_sparql12_gaps.jl")
    include("test_sparql12_complete.jl")
    include("test_sparql_tsv.jl")
    include("test_sparql_results_parser.jl")
    include("test_sparql_parser.jl")
    ...
    include("test_infixowl_extras.jl")
    ...
    include("test_w3c.jl")
    include("test_literal_extras.jl")
    include("test_format_roundtrip.jl")
    include("test_serializer_roundtrip.jl")
    include("test_issue_regressions.jl")
    include("test_jelly.jl")
    include("test_property_paths.jl")
    include("test_server.jl")
    include("test_geosparql.jl")
    include("test_querybuilder.jl")
